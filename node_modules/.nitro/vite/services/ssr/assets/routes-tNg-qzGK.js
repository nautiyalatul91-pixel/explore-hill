...
import "./hero-himalayas-Dx5R6vBe.js";
import { n as usePackages } from "./packages-De34pvPG.js";
import { t as gallery_group_default } from "./gallery-group-MaxqF0cG.js";
import { t as gallery_food_default } from "./gallery-food-CPHJ1Wb0.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, ChevronLeft, ChevronRight, Clock, Compass, Flame, Heart, MapPin, Mountain, ShieldCheck, Sparkles, Star, Users, Utensils } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				hasMultipleImages && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("button", {
					onClick: handlePrev,
					type: "button",
				...
				hasMultipleImages && /* @__PURE__ */ jsx("div", {
					className: "absolute bottom-16 left-1/2 -translate-x-1/2 z-20 flex gap-1.5",
					children: pkg.images.map((_, idx) => /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: (e) => {
							e.preventDefault();
							e.stopPropagation();
...
function Home() {
	...
	const renderHero = () => /* @__PURE__ */ jsxs("section", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("h1", {
						...
						children: homepageData?.hero_headline ? homepageData.hero_headline : /* @__PURE__ */ jsxs(Fragment, { children: [
							"Explore the",
							/* @__PURE__ */ jsx("br", {}),
							/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: statsList.map((s) => /* @__PURE__ */ jsxs("div", {
	...
	const renderFeatured = () => /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: packages.slice(0, 6).map((p) => /* @__PURE__ */ jsx(PackageCard, { pkg: p }, p.slug))
			})]
		})
	});
	const renderWhyUs = () => /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: whyUsList.map(({ icon: Icon, title, text }) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: Icon && /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5" })
						}),
						/* @__PURE__ */ jsx("h3", {
	...
	const renderCategories = () => /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: categoriesList.map((c) => /* @__PURE__ */ jsxs(Link, {
					to: c.to,
	...
	const renderTestimonials = () => /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: testimonialsList.map((t) => /* @__PURE__ */ jsxs("figure", {
	...
	const renderDepartures = () => /* @__PURE__ */ jsx("section", {
		className: "py-24 sm:py-32 bg-mist",
		children: /* @__PURE__ */ jsxs("div", {
			className: "mx-auto max-w-7xl px-4 sm:px-6",
			children: [/* @__PURE__ */ jsx("div", {
	...
	const renderFAQs = () => /* @__PURE__ */ jsx("section", {
		className: "py-24 sm:py-32 bg-background",
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				className: "space-y-3",
				children: faqsList.map((f) => /* @__PURE__ */ jsxs("details", {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [activeSections.map((sec) => {
		const renderFn = SECTIONS_MAP[sec.id];
		return renderFn ? /* @__PURE__ */ jsx(React.Fragment, { children: renderFn() }, sec.id) : null;
