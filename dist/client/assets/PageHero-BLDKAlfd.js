...
var t = e();
function n({ eyebrow: e, title: n, subtitle: r, image: i, children: a }) {
  return (0, t.jsxs)(`section`, {
    ...
    children: [
      ...
      (0, t.jsx)(`div`, {
        className: `absolute inset-0 bg-gradient-to-b from-ridge/40 via-ridge/40 to-ridge/95`,
      }),
      (0, t.jsx)(`div`, { className: `absolute inset-0 bg-aurora opacity-40` }),
      (0, t.jsxs)(`div`, {
