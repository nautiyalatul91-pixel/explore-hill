  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsx(PageHero, {
        ...
        subtitle:
          "Slow travel, village hospitality and the rituals that shape Uttarakhand — designed for travelers who want to feel, not just see.",
          ...
          children: /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("p", {
                ...
                children:
                  "A three-day circuit through ancient temples, riverside villages and sacred mountain trails.",
              }),
              /* @__PURE__ */ jsx("ol", {
                className:
                  "mt-10 relative border-l-2 border-dashed border-primary/30 pl-8 space-y-6",
                children: mahasu.route.map((stop, i) =>
                  /* @__PURE__ */ jsxs(
                    "li",
                    {
                      className: "relative",
                      children: [
                        /* @__PURE__ */ jsx("span", {
                          className:
                            "absolute -left-[42px] grid h-8 w-8 place-items-center rounded-full bg-[var(--gradient-brand)] text-white text-xs font-bold shadow-card",
                          children: i + 1,
                        }),
                        /* @__PURE__ */ jsxs("div", {
                          className:
                            "flex items-center gap-2 font-display text-xl font-semibold text-foreground",
                          children: [
                            /* @__PURE__ */ jsx(MapPin, {
