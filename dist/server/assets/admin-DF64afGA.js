...
function AdminPage() {
  ...
  if (auth === "not-admin")
    return /* @__PURE__ */ jsx("section", {
      className:
        "min-h-[100svh] grid place-items-center bg-background pt-32 pb-16 px-4",
      children: /* @__PURE__ */ jsxs("div", {
        className:
          "max-w-md text-center rounded-3xl bg-card border border-border p-10 shadow-card",
        children: [
          /* @__PURE__ */ jsx("div", {
            className:
              "mx-auto grid h-14 w-14 place-items-center rounded-full bg-destructive/10 text-destructive",
          ...
          /* @__PURE__ */ jsx("p", {
            ...
            children:
              "Your account is signed in but doesn't have admin privileges. Ask Atul to grant you the admin role.",
          }),
          /* @__PURE__ */ jsxs("button", {
            onClick: () => supabase.auth.signOut(),
            className:
              "mt-6 inline-flex items-center gap-2 rounded-xl bg-secondary px-5 py-2.5 text-sm font-semibold text-foreground",
            children: [
      ...
      /* @__PURE__ */ jsx("section", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("input", {
                      ...
                      className:
                        "w-full pl-9 pr-4 py-2.5 rounded-xl border border-input bg-card text-sm focus:outline-none focus:ring-2 focus:ring-ring",
                    }),
                  ],
                }),
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("button", {
                      onClick: () => supabase.auth.signOut(),
                      className:
                        "ml-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-secondary text-foreground hover:bg-accent",
                      children: [
                        /* @__PURE__ */ jsx(LogOut, {
            ...
            /* @__PURE__ */ jsx("div", {
              className:
                "rounded-2xl bg-card border border-border shadow-card overflow-hidden",
              children: loading
                ? /* @__PURE__ */ jsx("div", {
                ...
                : filtered.length === 0
                  ? /* @__PURE__ */ jsx("div", {
                      className:
                        "p-16 text-center text-muted-foreground text-sm",
                  ...
                  : /* @__PURE__ */ jsx("div", {
                      ...
                      children: /* @__PURE__ */ jsxs("table", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("thead", {
                            className:
                              "bg-secondary text-xs uppercase tracking-wider text-muted-foreground",
                          ...
                          /* @__PURE__ */ jsx("tbody", {
                            children: filtered.map((b) =>
                              /* @__PURE__ */ jsxs(
                                ...
                                {
                                  className:
                                    "border-t border-border align-top hover:bg-secondary/40",
                                  children: [
                                    /* @__PURE__ */ jsxs("td", {
                                      className: "p-4",
                                      children: [
                                    ...
                                    /* @__PURE__ */ jsxs("td", {
                                      ...
                                      children: [
                                        ...
                                        b.special_requirements &&
                                          /* @__PURE__ */ jsx("div", {
                                            className:
                                              "text-xs text-muted-foreground mt-1 max-w-xs line-clamp-2",
                                        ...
                                        children: [
                                          b.status !== "confirmed" &&
                                            /* @__PURE__ */ jsx("button", {
                                              ...
                                              className:
                                                "px-3 py-1.5 rounded-full text-xs font-semibold bg-forest text-forest-foreground hover:opacity-90",
                                              children: "Confirm",
                                            }),
                                          b.status !== "cancelled" &&
                                            /* @__PURE__ */ jsx("button", {
                                              ...
                                              className:
                                                "px-3 py-1.5 rounded-full text-xs font-semibold bg-secondary text-foreground hover:bg-accent",
                                              children: "Cancel",
                                            }),
                                        ],
                                      }),
...
function SignIn() {
  ...
  return /* @__PURE__ */ jsx("section", {
    className:
      "min-h-[100svh] grid place-items-center px-4 pt-32 pb-16 bg-aurora",
    children: /* @__PURE__ */ jsxs("form", {
      onSubmit: handle,
      className:
        "w-full max-w-md rounded-3xl glass-dark p-8 text-white shadow-elegant",
      children: [
        /* @__PURE__ */ jsx("p", {
          className:
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsx("input", {
              ...
              placeholder: "Email",
              className:
                "w-full rounded-xl bg-white/10 border border-white/20 px-4 py-3 text-sm text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-ember",
            }),
            /* @__PURE__ */ jsx("input", {
              name: "password",
              type: "password",
        ...
        /* @__PURE__ */ jsxs("button", {
          ...
          type: "submit",
          className:
            "mt-5 w-full rounded-xl bg-[var(--gradient-ember)] text-ember-foreground py-3 text-sm font-semibold shadow-glow disabled:opacity-60 inline-flex items-center justify-center gap-2",
          children: [
            busy &&
