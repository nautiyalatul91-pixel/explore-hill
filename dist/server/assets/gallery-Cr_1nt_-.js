...
import {
  n as trek_nagtibba_default,
  r as trek_moila_default,
  t as trek_yulla_default,
} from "./trek-yulla-DqDE_bPL.js";
import {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsx(PageHero, {
        ...
        subtitle:
          "Mountains, villages, bonfires and the people who make our trips unforgettable.",
      ...
      /* @__PURE__ */ jsx("section", {
        ...
        children: /* @__PURE__ */ jsx("div", {
          ...
          children: /* @__PURE__ */ jsx("div", {
            className:
              "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 auto-rows-[180px] sm:auto-rows-[220px] gap-3",
                ...
                "figure",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("img", {
                      ...
                      loading: "lazy",
                      className:
                        "absolute inset-0 h-full w-full object-cover transition-transform duration-[1500ms] group-hover:scale-110",
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className:
                        "absolute inset-0 bg-gradient-to-t from-ridge/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity",
                    }),
                    /* @__PURE__ */ jsx("figcaption", {
                      className:
                        "absolute bottom-3 left-3 right-3 text-xs font-semibold uppercase tracking-wider text-white opacity-0 group-hover:opacity-100 transition-opacity",
                      children: it.tag,
                    }),
                  ],
                },
