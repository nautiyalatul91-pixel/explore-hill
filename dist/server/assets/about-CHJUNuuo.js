	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					className: "relative",
					children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-4 bg-[var(--gradient-brand)] opacity-20 blur-3xl rounded-3xl" }), /* @__PURE__ */ jsx("img", {
						src: founder_default,
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "To open Uttarakhand's hidden corners to travelers in a way that uplifts local communities, protects fragile ecosystems and leaves every guest with a story worth telling."
						})
					]
				}), /* @__PURE__ */ jsxs("div", {
					className: "rounded-3xl glass-dark p-8",
					children: [
						...
						/* @__PURE__ */ jsx("p", {
							className: "mt-4 text-white/75",
							children: "To become India's most trusted small-group Himalayan travel brand — a name travelers, villages and the mountains themselves can rely on."
						})
					]
				})]
			})]
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: values.map(({ icon: Icon, title, text }) => /* @__PURE__ */ jsxs("div", {
