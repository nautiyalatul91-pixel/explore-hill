...
import {
  ...
  r as treks,
  t as allPackages,
} from "./packages-CLS7Ed0o.js";
import {
  n as gallery_food_default,
  t as gallery_group_default,
} from "./gallery-group-C_0vxpEE.js";
...
function PackageCard({ pkg }) {
  return /* @__PURE__ */ jsxs("article", {
    className:
      "group relative overflow-hidden rounded-3xl bg-card shadow-card hover-lift",
    children: [
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", {
            className:
              "absolute inset-0 bg-gradient-to-t from-ridge/80 via-ridge/10 to-transparent",
          }),
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("span", {
                className:
                  "rounded-full glass px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-ridge",
                children: pkg.category === "trek" ? "Trek" : "Trip",
              }),
              pkg.difficulty &&
                /* @__PURE__ */ jsx("span", {
                  className:
                    "rounded-full bg-ember/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-ember-foreground",
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("ul", {
            className:
              "mt-4 grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs text-foreground/80",
            children: pkg.highlights.slice(0, 4).map((h) =>
              /* @__PURE__ */ jsxs(
                "li",
                {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs(Link, {
                ...
                search: { pkg: pkg.slug },
                className:
                  "inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2.5 text-xs font-semibold text-primary-foreground hover:bg-primary/90 transition",
                children: [
                  "Book Now ",
    ...
    children: [
      /* @__PURE__ */ jsxs("section", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", {
            className:
              "absolute inset-0 bg-gradient-to-b from-ridge/30 via-ridge/40 to-ridge/90",
          }),
          /* @__PURE__ */ jsx("div", {
          ...
          /* @__PURE__ */ jsxs("div", {
            className:
              "relative z-10 mx-auto max-w-5xl px-6 pt-32 pb-24 text-center text-white",
            children: [
              /* @__PURE__ */ jsxs("span", {
                className:
              ...
              /* @__PURE__ */ jsxs("h1", {
                className:
                  "mt-6 font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[1.02] tracking-tight animate-fade-up",
                children: [
                  "Explore the",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", {
              ...
              /* @__PURE__ */ jsx("p", {
                className:
                  "mx-auto mt-6 max-w-2xl text-base sm:text-lg text-white/85 animate-fade-up",
                children:
                  "Authentic treks, village stays, camping experiences and spiritual journeys across Uttarakhand — crafted for couples, small groups and weekend wanderers.",
              }),
              /* @__PURE__ */ jsxs("div", {
                className:
                  "mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 animate-fade-up",
                children: [
                  /* @__PURE__ */ jsxs(Link, {
                    to: "/book",
                    className:
                      "inline-flex items-center gap-2 rounded-full bg-[var(--gradient-ember)] px-7 py-3.5 text-sm font-semibold text-ember-foreground shadow-glow hover:scale-[1.02] transition-transform",
                    children: [
                      "Book Your Adventure ",
                  ...
                  /* @__PURE__ */ jsx(Link, {
                    to: "/trips",
                    className:
                      "inline-flex items-center gap-2 rounded-full glass-dark border border-white/25 px-7 py-3.5 text-sm font-semibold text-white hover:bg-white/15 transition",
              ...
              /* @__PURE__ */ jsx("div", {
                className:
                  "mt-20 grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-3xl mx-auto",
                  ...
                  /* @__PURE__ */ jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("div", {
                          className:
                            "mt-1 text-[11px] uppercase tracking-wider text-white/70",
                          children: s.label,
                        }),
                      ],
                    },
          ...
          /* @__PURE__ */ jsx("div", {
            className:
              "absolute bottom-6 left-1/2 -translate-x-1/2 text-white/60 text-xs tracking-widest uppercase animate-float",
              ...
              children: [
                /* @__PURE__ */ jsxs("div", {
                  children: [
                    ...
                    /* @__PURE__ */ jsx("h2", {
                      className:
                        "mt-3 font-display text-4xl sm:text-5xl font-bold text-foreground max-w-2xl",
                      children:
                ...
                /* @__PURE__ */ jsxs(Link, {
                  to: "/treks",
                  className:
                    "inline-flex items-center gap-2 text-sm font-semibold text-primary hover:gap-3 transition-all",
                  children: [
                    "View all treks ",
                    /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }),
                  ],
      ...
      /* @__PURE__ */ jsxs("section", {
        className:
          "relative py-24 sm:py-32 overflow-hidden bg-ridge text-white",
        children: [
          /* @__PURE__ */ jsx("div", {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("h2", {
                    className:
                      "mt-3 font-display text-4xl sm:text-5xl font-bold",
                    children: [
                  ...
                  /* @__PURE__ */ jsx("p", {
                    ...
                    children:
                      "We're a small Uttarakhand-rooted team building intimate experiences that respect local culture, support village communities and put travelers first.",
                  }),
                ],
              }),
              /* @__PURE__ */ jsx("div", {
                className: "mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3",
                children: whyUs.map(({ icon: Icon, title, text }) =>
                  /* @__PURE__ */ jsxs(
                    "div",
                    {
                      className:
                        "group rounded-2xl glass-dark p-6 hover:bg-white/10 transition-colors",
                      children: [
                        /* @__PURE__ */ jsx("div", {
                          className:
                            "grid h-12 w-12 place-items-center rounded-xl bg-[var(--gradient-ember)] text-ember-foreground shadow-glow",
              ...
              children: categories.map((c) =>
                /* @__PURE__ */ jsxs(
                  Link,
                  {
                    to: c.to,
                    className:
                      "group relative aspect-[3/4] overflow-hidden rounded-3xl shadow-card hover-lift",
                    children: [
                      /* @__PURE__ */ jsx("img", {
                        src: c.image,
                        alt: c.title,
                        loading: "lazy",
                        className:
                          "absolute inset-0 h-full w-full object-cover transition-transform duration-[1200ms] group-hover:scale-110",
                      }),
                      /* @__PURE__ */ jsx("div", {
                        className:
                          "absolute inset-0 bg-gradient-to-t from-ridge via-ridge/30 to-transparent",
                      }),
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("p", {
                            className:
                              "text-[11px] uppercase tracking-widest text-white/70",
                            children: c.count,
                          }),
                          /* @__PURE__ */ jsx("h3", {
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: testimonials.map((t) =>
                /* @__PURE__ */ jsxs(
                  ...
                  {
                    className:
                      "rounded-3xl bg-card border border-border p-7 shadow-card hover-lift",
                    children: [
                      /* @__PURE__ */ jsx("div", {
                      ...
                      /* @__PURE__ */ jsxs("blockquote", {
                        className:
                          "mt-4 font-display text-lg leading-snug text-foreground",
                        children: ['"', t.text, '"'],
                      }),
                      /* @__PURE__ */ jsxs("figcaption", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("div", {
                            className:
                              "grid h-11 w-11 place-items-center rounded-full bg-[var(--gradient-brand)] text-white font-semibold",
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: allPackages.slice(0, 4).map((p, i) => {
                ...
                return /* @__PURE__ */ jsxs(
                  ...
                  {
                    className:
                      "flex flex-col sm:flex-row sm:items-center gap-4 rounded-2xl bg-card border border-border p-5 shadow-card hover:shadow-elegant transition-shadow",
                    children: [
                      /* @__PURE__ */ jsx("img", {
                        src: p.image,
                        alt: p.name,
                        loading: "lazy",
                        className:
                          "h-20 w-full sm:w-28 rounded-xl object-cover",
                      }),
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("div", {
                            ...
                            children: [p.duration, " · Departs ", formatted],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxs("div", {
                      ...
                      /* @__PURE__ */ jsxs(Link, {
                        ...
                        search: { pkg: p.slug },
                        className:
                          "inline-flex items-center justify-center gap-1.5 rounded-full bg-[var(--gradient-ember)] text-ember-foreground px-5 py-2.5 text-xs font-semibold shadow-glow",
                        children: [
                          "Reserve ",
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: faqs.map((f) =>
                /* @__PURE__ */ jsxs(
                  ...
                  {
                    className:
                      "group rounded-2xl bg-card border border-border p-6 shadow-card",
                    children: [
                      /* @__PURE__ */ jsxs("summary", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", {
                            className:
                              "font-display text-lg font-semibold text-foreground pr-4",
                            children: f.q,
                          }),
                          /* @__PURE__ */ jsx("span", {
                            className:
                              "grid h-8 w-8 place-items-center rounded-full bg-secondary text-primary group-open:rotate-45 transition-transform",
                            children: "+",
                          }),
                        ],
                      }),
      ...
      /* @__PURE__ */ jsxs("section", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", {
            className:
              "absolute inset-0 bg-gradient-to-r from-ridge/95 via-ridge/85 to-ridge/70",
          }),
          /* @__PURE__ */ jsxs("div", {
            className: "relative mx-auto max-w-4xl px-6 text-center text-white",
            children: [
              /* @__PURE__ */ jsx(Mountain, {
                className: "mx-auto h-10 w-10 text-ember",
              }),
              /* @__PURE__ */ jsxs("h2", {
                className:
                  "mt-5 font-display text-4xl sm:text-6xl font-bold leading-tight",
                children: [
              ...
              /* @__PURE__ */ jsx("p", {
                ...
                children:
                  "Book a seat with us and discover why thousands of travelers call Explore Hills their go-to Himalayan crew.",
              }),
              /* @__PURE__ */ jsxs(Link, {
                to: "/book",
                className:
                  "mt-10 inline-flex items-center gap-2 rounded-full bg-[var(--gradient-ember)] px-7 py-3.5 text-sm font-semibold text-ember-foreground shadow-glow hover:scale-[1.02] transition-transform",
                children: [
                  "Book Your Adventure ",
                  /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }),
                ],
