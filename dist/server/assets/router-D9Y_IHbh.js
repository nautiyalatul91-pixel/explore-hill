import {
  n as trip_mahasu_default,
  t as trek_kedarkantha_default,
} from "./trek-kedarkantha-Jx50rRly.js";
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: /* @__PURE__ */ jsx(Link, {
                to: "/book",
                className:
                  "inline-flex items-center gap-2 rounded-xl bg-[var(--gradient-ember)] px-5 py-2.5 text-sm font-semibold text-ember-foreground shadow-glow hover:opacity-95 transition",
                children: "Book Now",
              }),
            }),
            /* @__PURE__ */ jsx("button", {
        ...
        open &&
          /* @__PURE__ */ jsx("div", {
            className:
              "lg:hidden mt-2 rounded-2xl glass p-3 shadow-elegant animate-fade-up",
            children: /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                NAV.map((item) =>
                  /* @__PURE__ */ jsx(
                    Link,
                    {
                      to: item.to,
                      className:
                        "px-4 py-3 rounded-lg text-sm font-medium text-foreground hover:bg-secondary",
                      activeProps: {
                        className:
                ...
                /* @__PURE__ */ jsx(Link, {
                  to: "/book",
                  className:
                    "mt-2 inline-flex items-center justify-center rounded-xl bg-[var(--gradient-ember)] px-5 py-3 text-sm font-semibold text-ember-foreground shadow-glow",
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("p", {
                    ...
                    children:
                      "Authentic Himalayan adventures, small-group experiences and hidden destinations of Uttarakhand.",
                  }),
                ],
              }),
              /* @__PURE__ */ jsxs("div", {
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("a", {
                        ...
                        rel: "noreferrer",
                        className:
                          "inline-flex items-center justify-center gap-2 rounded-xl bg-[oklch(0.62_0.16_150)] px-4 py-2.5 text-sm font-semibold text-white hover:opacity-95 transition",
                        children: [
                      ...
                      /* @__PURE__ */ jsx(Link, {
                        to: "/book",
                        className:
                          "inline-flex items-center justify-center gap-2 rounded-xl bg-white text-ridge px-4 py-2.5 text-sm font-semibold hover:bg-white/90 transition",
                        children: "Book Your Adventure",
                      }),
                    ],
                  }),
          ...
          /* @__PURE__ */ jsxs("div", {
            className:
              "mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/50",
            children: [
              /* @__PURE__ */ jsxs("p", {
                children: [
                  "© ",
              ...
              /* @__PURE__ */ jsx("p", {
                children: "Travel responsibly. Leave only footprints.",
              }),
            ],
          }),
        ],
...
function FloatingWhatsApp() {
  return /* @__PURE__ */ jsx("a", {
    ...
    className:
      "fixed bottom-6 right-6 z-50 grid h-14 w-14 place-items-center rounded-full bg-[oklch(0.62_0.18_150)] text-white shadow-glow hover:scale-105 transition-transform animate-float",
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Premium small-group treks, village stays, camping and spiritual journeys across the hidden Himalayas of Uttarakhand. Founded by Atul Nautiyal.",
      },
      {
        name: "author",
