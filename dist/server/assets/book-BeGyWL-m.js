...
function BookPage() {
  ...
  if (done)
    return /* @__PURE__ */ jsx("section", {
      className:
        "min-h-[100svh] flex items-center justify-center bg-aurora text-white px-4 pt-28 pb-20",
      children: /* @__PURE__ */ jsxs("div", {
        className:
          "max-w-xl w-full rounded-3xl glass-dark p-10 text-center shadow-elegant",
        children: [
          /* @__PURE__ */ jsx("div", {
            className:
              "mx-auto grid h-16 w-16 place-items-center rounded-full bg-[var(--gradient-ember)] text-ember-foreground shadow-glow",
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("a", {
                ...
                rel: "noreferrer",
                className:
                  "inline-flex items-center justify-center rounded-full bg-white text-ridge px-6 py-3 text-sm font-semibold",
                children: "Chat on WhatsApp",
              }),
              /* @__PURE__ */ jsx("button", {
                onClick: () => navigate({ to: "/" }),
                className:
                  "inline-flex items-center justify-center rounded-full bg-white/10 border border-white/20 px-6 py-3 text-sm font-semibold",
                children: "Back home",
              }),
            ],
          }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsx(PageHero, {
        ...
        subtitle:
          "Fill in your details below. Our team will confirm on WhatsApp within hours and walk you through payment.",
      ...
      /* @__PURE__ */ jsx("section", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          className:
            "mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-[1.5fr_1fr] gap-8",
          children: [
            /* @__PURE__ */ jsxs("form", {
              onSubmit,
              className:
                "rounded-3xl bg-card border border-border p-7 sm:p-10 shadow-card space-y-5",
              children: [
                /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsxs("div", {
                  children: [
                    ...
                    /* @__PURE__ */ jsx("textarea", {
                      ...
                      rows: 4,
                      placeholder:
                        "Dietary needs, fitness concerns, special occasions…",
                      className:
                        "mt-2 w-full rounded-xl border border-input bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring",
                    }),
                  ],
                ...
                /* @__PURE__ */ jsx("button", {
                  ...
                  disabled: submitting,
                  className:
                    "w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--gradient-ember)] px-6 py-4 text-sm font-semibold text-ember-foreground shadow-glow disabled:opacity-60",
                  children: submitting
                ...
                /* @__PURE__ */ jsxs("p", {
                  className:
                    "text-xs text-muted-foreground text-center flex items-center justify-center gap-1.5",
                  children: [
            ...
            /* @__PURE__ */ jsxs("aside", {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", {
                  className:
                    "rounded-3xl bg-ridge text-white p-7 relative overflow-hidden",
                  children: [
                    /* @__PURE__ */ jsx("div", {
                    ...
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("ul", {
                          ...
                          children: inclusions.map((i) =>
                            /* @__PURE__ */ jsxs(
                              "li",
                              {
                                className:
                                  "flex items-start gap-3 text-sm text-white/85",
                                children: [
                                  /* @__PURE__ */ jsx("span", {
                                    className:
                                      "grid h-6 w-6 place-items-center rounded-full bg-[var(--gradient-ember)] text-ember-foreground shrink-0",
                ...
                /* @__PURE__ */ jsxs("div", {
                  className:
                    "rounded-3xl bg-card border border-border p-7 shadow-card",
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      className:
                        "text-xs font-semibold uppercase tracking-[0.2em] text-ember",
                    ...
                    /* @__PURE__ */ jsx("p", {
                      ...
                      children:
                        "Just enough to make friends, small enough to keep the trail peaceful.",
                    }),
                  ],
                }),
              ],
